...
REM ------------------------------
set "TARGET_DIRS=test\driver_asyncpg test\driver_psycopg_async test\driver_psycopg_sync test\driver_aiosqlite test\driver_sqlite3 test\driver_turso_sync test\driver_turso_async test\driver_pymysql test\driver_asyncmy"
