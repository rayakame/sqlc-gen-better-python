...
func (b *IndentStringBuilder) WriteQueryResultsIterDocstring() {
	if b.docstringConvention == core.DocstringConventionNone {
		return
	}
	b.WriteIndentedLine(2, `"""`+"Initialize iteration support.")
	b.NewLine()
	if b.docstringConvention == core.DocstringConventionNumpy {
	...
	} else if b.docstringConvention == core.DocstringConventionGoogle {
		b.WriteIndentedLine(2, "Returns:")
		b.WriteIndentedLine(3, "Self as an iterator.")
	} else if b.docstringConvention == core.DocstringConventionPEP257 {
		b.WriteIndentedLine(2, "Returns:")
...
func (b *IndentStringBuilder) WriteQueryFunctionDocstring(lvl int, query *core.Query, docstringConnType string, queryArgs []core.FunctionArg, returnType core.PyType) {
	...
	if query.Cmd == metadata.CmdExec {
		...
		if b.docstringConvention == core.DocstringConventionNumpy {
			...
			if b.docstringDriver == core.SQLDriverAioSQLite {
