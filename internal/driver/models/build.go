...
func BuildModel(modelType string, table *core.Table, body *codegen.IndentStringBuilder) {
...
func BuildPyTables(imp *core.Importer, tables []core.Table) (string, []byte, error) {
	fileName := "models.sql"
	...
	for _, table := range tables {
		body.WriteString("\n")
		body.WriteString("\n")
		BuildModel(imp.C.ModelType, &table, body)
	}
