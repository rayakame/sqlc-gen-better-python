...
import (
	...
	"github.com/rayakame/sqlc-gen-better-python/internal/driver/drivers"
)

type TypeBuildPyQueryFunc func(*core.Query, *codegen.IndentStringBuilder, string, string) error
