...
async def insert_one_sqlite_type(
    ...
    *,
    ...
    await conn.execute(INSERT_ONE_SQLITE_TYPE, sql_args)
...
async def get_one_sqlite_type(conn: turso.aio.Connection, *, id_: int) -> models.TestSqliteType | None:
...
async def get_one_inner_sqlite_type(conn: turso.aio.Connection, *, table_id: int) -> models.TestInnerSqliteType | None:
...
async def get_one_date(conn: turso.aio.Connection, *, id_: int, date_test: datetime.date) -> datetime.date | None:
    ...
    """
    row = await (await conn.execute(GET_ONE_DATE, (id_, date_test.isoformat()))).fetchone()
    if row is None:
        return None
    return datetime.date.fromisoformat(row[0])


async def get_one_datetime(conn: turso.aio.Connection, *, id_: int, datetime_test: datetime.datetime) -> datetime.datetime | None:
    ...
    """
    row = await (await conn.execute(GET_ONE_DATETIME, (id_, datetime_test.isoformat()))).fetchone()
    if row is None:
        return None
    return datetime.datetime.fromisoformat(row[0])


async def get_one_timestamp(conn: turso.aio.Connection, *, id_: int, timestamp_test: datetime.datetime) -> datetime.datetime | None:
    ...
    Returns:
        Result of type `datetime.datetime` fetched from the db. Will be `None` if not found.
    """
    row = await (await conn.execute(GET_ONE_TIMESTAMP, (id_, timestamp_test.isoformat()))).fetchone()
    if row is None:
        return None
    return datetime.datetime.fromisoformat(row[0])


async def get_one_bool(conn: turso.aio.Connection, *, id_: int, bool_test: bool) -> bool | None:
...
async def get_one_boolean(conn: turso.aio.Connection, *, id_: int, boolean_test: bool) -> bool | None:
...
async def get_one_decimal(conn: turso.aio.Connection, *, id_: int, decimal_test: decimal.Decimal) -> decimal.Decimal | None:
    ...
    """
    row = await (await conn.execute(GET_ONE_DECIMAL, (id_, str(decimal_test)))).fetchone()
    if row is None:
        return None
    return decimal.Decimal(str(row[0]))


async def get_one_blob(conn: turso.aio.Connection, *, id_: int, blob_test: memoryview) -> memoryview | None:
    ...
    """
    row = await (await conn.execute(GET_ONE_BLOB, (id_, bytes(blob_test)))).fetchone()
    if row is None:
        return None
    return memoryview(row[0])


def get_many_sqlite_type(conn: turso.aio.Connection, *, id_: int) -> QueryResults[models.TestSqliteType]:
...
def get_many_inner_sqlite_type(conn: turso.aio.Connection, *, table_id: int) -> QueryResults[models.TestInnerSqliteType]:
...
def get_many_nullable_inner_sqlite_type(conn: turso.aio.Connection, *, table_id: int, int_test: int | None) -> QueryResults[models.TestInnerSqliteType]:
...
def get_many_date(conn: turso.aio.Connection, *, id_: int, date_test: datetime.date) -> QueryResults[datetime.date]:
...
def get_many_datetime(conn: turso.aio.Connection, *, id_: int, datetime_test: datetime.datetime) -> QueryResults[datetime.datetime]:
...
def get_many_timestamp(conn: turso.aio.Connection, *, id_: int, timestamp_test: datetime.datetime) -> QueryResults[datetime.datetime]:
...
def get_many_bool(conn: turso.aio.Connection, *, id_: int, bool_test: bool) -> QueryResults[bool]:
...
def get_many_boolean(conn: turso.aio.Connection, *, id_: int, boolean_test: bool) -> QueryResults[bool]:
...
def get_many_decimal(conn: turso.aio.Connection, *, id_: int, decimal_test: decimal.Decimal) -> QueryResults[decimal.Decimal]:
...
def get_many_blob(conn: turso.aio.Connection, *, id_: int, blob_test: memoryview) -> QueryResults[memoryview]:
...
async def delete_one_sqlite_type(conn: turso.aio.Connection, *, id_: int) -> None:
...
async def delete_one_test_inner_sqlite_type(conn: turso.aio.Connection, *, table_id: int) -> None:
...
async def insert_result_one_sqlite_type(
    ...
    *,
    ...
    Returns:
        The result of type `turso.aio.Cursor` returned when executing the query.
    """
    sql_args = (
        id_,
        int_test,
...
async def update_result_one_sqlite_type(conn: turso.aio.Connection, *, id_: int) -> turso.aio.Cursor:
...
async def delete_result_one_sqlite_type(conn: turso.aio.Connection, *, id_: int) -> turso.aio.Cursor:
...
async def update_rows_one_sqlite_type(conn: turso.aio.Connection, *, id_: int) -> int:
...
async def delete_rows_one_sqlite_type(conn: turso.aio.Connection, *, id_: int) -> int:
...
async def create_rows_table(conn: turso.aio.Connection) -> int:
...
async def update_last_id_one_sqlite_type(conn: turso.aio.Connection, *, id_: int) -> int | None:
...
async def delete_last_id_one_sqlite_type(conn: turso.aio.Connection, *, id_: int) -> int | None:
...
async def insert_type_override(conn: turso.aio.Connection, *, id_: int, text_test: UserString | None) -> None:
...
async def get_one_type_override(conn: turso.aio.Connection, *, id_: int) -> models.TestTypeOverride | None:
...
def get_many_type_override(conn: turso.aio.Connection, *, id_: int) -> QueryResults[models.TestTypeOverride]:
...
async def get_one_text_type_override(conn: turso.aio.Connection, *, id_: int) -> UserString | None:
...
def get_many_text_type_override(conn: turso.aio.Connection, *, id_: int) -> QueryResults[UserString | None]:
...
async def delete_type_override(conn: turso.aio.Connection, *, id_: int) -> None:
