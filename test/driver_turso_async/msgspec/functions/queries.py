...
class QueryResults[T]:
    ...
    def __init__(
        ...
        *args: QueryResultsArgsType,
        ...
        Arguments:
        conn -- The connection object of type `turso.aio.Connection` used to execute queries.
...
async def insert_one_sqlite_type(
    ...
    *,
    ...
    Arguments:
    conn -- Connection object of type `turso.aio.Connection` used to execute the query.
    id_ -- int.
    int_test -- int.
    bigint_test -- int.
    smallint_test -- int.
...
async def insert_result_one_sqlite_type(
    ...
    *,
    ...
    Returns:
    turso.aio.Cursor -- The result returned when executing the query.
    """
    sql_args = (
        id_,
        int_test,
