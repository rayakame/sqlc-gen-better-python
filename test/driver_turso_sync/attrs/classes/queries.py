...
class Queries:
    ...
    def get_one_sqlite_type(self, *, id_: int) -> models.TestSqliteType | None:
        ...
        return models.TestSqliteType(
            ...
            date_test=ciso8601.parse_datetime(row[17]).date(),
            datetime_test=ciso8601.parse_datetime(row[18]),
            timestamp_test=ciso8601.parse_datetime(row[19]),
    ...
    def get_one_inner_sqlite_type(self, *, table_id: int) -> models.TestInnerSqliteType | None:
        ...
        return models.TestInnerSqliteType(
            ...
            date_test=ciso8601.parse_datetime(row[17]).date() if row[17] is not None else None,
            datetime_test=ciso8601.parse_datetime(row[18]) if row[18] is not None else None,
            timestamp_test=ciso8601.parse_datetime(row[19]) if row[19] is not None else None,
            character_test=row[20],
            varchar_test=row[21],
            varyingcharacter_test=row[22],
            nchar_test=row[23],
