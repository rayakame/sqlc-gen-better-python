...
class QueryResults[T]:
    ...
    def __init__(
        ...
        *args: QueryResultsArgsType,
        ...
        Args:
            conn:
                The connection object of type `turso.Connection` used to execute queries.
            sql:
...
def insert_one_sqlite_type(
    ...
    *,
    ...
    Args:
        conn:
            Connection object of type `turso.Connection` used to execute the query.
        id_: int.
        int_test: int.
        bigint_test: int.
        smallint_test: int.
...
def insert_result_one_sqlite_type(
    ...
    *,
    ...
    Returns:
        The result of type `turso.Cursor` returned when executing the query.
    """
    sql_args = (
        id_,
        int_test,
