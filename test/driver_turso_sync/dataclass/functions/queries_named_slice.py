...
def get_named_slice_rows(conn: turso.Connection, *, ids: collections.abc.Sequence[int], wanted: str) -> QueryResults[models.TestSlice]:
...
def get_named_slice_rows_reused(conn: turso.Connection, *, ids: collections.abc.Sequence[int], wanted: str) -> QueryResults[models.TestSlice]:
...
def get_named_slice_rows_arg_first(conn: turso.Connection, *, wanted: str, ids: collections.abc.Sequence[int]) -> QueryResults[models.TestSlice]:
...
def get_named_slice_row(conn: turso.Connection, *, ids: collections.abc.Sequence[int], wanted: str) -> models.TestSlice | None:
