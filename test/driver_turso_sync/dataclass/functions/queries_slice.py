...
def insert_slice_row(conn: turso.Connection, *, id_: int, name: str, note: str | None) -> None:
...
def get_slice_rows(conn: turso.Connection, *, ids: collections.abc.Sequence[int]) -> QueryResults[models.TestSlice]:
...
def get_slice_row_filtered(conn: turso.Connection, *, name: str, ids: collections.abc.Sequence[int], id_: int) -> models.TestSlice | None:
...
def get_slice_rows_by_notes(conn: turso.Connection, *, notes: collections.abc.Sequence[str]) -> QueryResults[models.TestSlice]:
...
def get_first_slice_name(conn: turso.Connection, *, ids: collections.abc.Sequence[int], names: collections.abc.Sequence[str]) -> str | None:
...
def get_slice_rows_by_name_or_note(conn: turso.Connection, *, names: collections.abc.Sequence[str]) -> QueryResults[models.TestSlice]:
...
def get_slice_rows_by_name_or_note_filtered(conn: turso.Connection, *, names: collections.abc.Sequence[str], id_: int) -> QueryResults[models.TestSlice]:
...
def delete_slice_rows(conn: turso.Connection, *, ids: collections.abc.Sequence[int]) -> int:
