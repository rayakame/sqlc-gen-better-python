...
async def get_one_test_postgres_type(conn: ConnectionLike, *, id_: int) -> models.TestPostgresType | None:
    ...
    """
    row = await (await conn.execute(GET_ONE_TEST_POSTGRES_TYPE, {"p1": id_})).fetchone()
    if row is None:
        return None
...
async def get_one_inner_test_postgres_type(conn: ConnectionLike, *, table_id: int) -> models.TestInnerPostgresType | None:
    ...
    """
    row = await (await conn.execute(GET_ONE_INNER_TEST_POSTGRES_TYPE, {"p1": table_id})).fetchone()
    if row is None:
        return None
...
async def get_one_test_timestamp_postgres_type(conn: ConnectionLike, *, id_: int) -> datetime.datetime | None:
    ...
    """
    row = await (await conn.execute(GET_ONE_TEST_TIMESTAMP_POSTGRES_TYPE, {"p1": id_})).fetchone()
    if row is None:
        return None
    return row[0]
...
async def get_one_test_bytea_postgres_type(conn: ConnectionLike, *, id_: int) -> memoryview | None:
    ...
    """
    row = await (await conn.execute(GET_ONE_TEST_BYTEA_POSTGRES_TYPE, {"p1": id_})).fetchone()
    if row is None:
        return None
...
async def get_embedded_test_postgres_type(conn: ConnectionLike, *, id_: int) -> GetEmbeddedTestPostgresTypeRow | None:
    ...
    """
    row = await (await conn.execute(GET_EMBEDDED_TEST_POSTGRES_TYPE, {"p1": id_})).fetchone()
    if row is None:
        return None
...
async def get_all_embedded_test_postgres_type(conn: ConnectionLike, *, id_: int) -> GetAllEmbeddedTestPostgresTypeRow | None:
    ...
    """
    row = await (await conn.execute(GET_ALL_EMBEDDED_TEST_POSTGRES_TYPE, {"p1": id_})).fetchone()
    if row is None:
        return None
...
async def create_one_test_postgres_type(
    ...
    *,
    ...
    await conn.execute(CREATE_ONE_TEST_POSTGRES_TYPE, sql_params)
...
async def create_one_test_postgres_inner_type(
    ...
    *,
    ...
    await conn.execute(CREATE_ONE_TEST_POSTGRES_INNER_TYPE, sql_params)
...
async def delete_one_test_postgres_type(conn: ConnectionLike, *, id_: int) -> None:
    ...
    Args:
        ...
        id_: int.
    """
    await conn.execute(DELETE_ONE_TEST_POSTGRES_TYPE, {"p1": id_})
...
async def delete_one_test_postgres_inner_type(conn: ConnectionLike, *, table_id: int) -> None:
    ...
    Args:
        ...
        table_id: int.
    """
    await conn.execute(DELETE_ONE_TEST_POSTGRES_INNER_TYPE, {"p1": table_id})
...
async def create_result_one_test_postgres_type(
    ...
    *,
    ...
    return await conn.execute(CREATE_RESULT_ONE_TEST_POSTGRES_TYPE, sql_params)


async def update_result_test_postgres_type(conn: ConnectionLike, *, id_: int) -> psycopg.AsyncCursor[psycopg.rows.TupleRow]:
    ...
    Returns:
        The result of type `psycopg.AsyncCursor[psycopg.rows.TupleRow]` returned when executing the query.
    """
    return await conn.execute(UPDATE_RESULT_TEST_POSTGRES_TYPE, {"p1": id_})


async def delete_one_result_test_postgres_type(conn: ConnectionLike, *, id_: int) -> psycopg.AsyncCursor[psycopg.rows.TupleRow]:
    ...
    Returns:
        The result of type `psycopg.AsyncCursor[psycopg.rows.TupleRow]` returned when executing the query.
    """
    return await conn.execute(DELETE_ONE_RESULT_TEST_POSTGRES_TYPE, {"p1": id_})
...
async def create_rows_one_test_postgres_type(
    ...
    *,
    ...
    cur = await conn.execute(CREATE_ROWS_ONE_TEST_POSTGRES_TYPE, sql_params)
    return cur.rowcount
...
async def insert_type_override(conn: ConnectionLike, *, id_: int, text_test: UserString | None) -> None:
    ...
    """
    await conn.execute(INSERT_TYPE_OVERRIDE, {"p1": id_, "p2": str(text_test) if text_test is not None else None})
...
async def get_one_type_override(conn: ConnectionLike, *, id_: int) -> models.TestTypeOverride | None:
    ...
    """
    row = await (await conn.execute(GET_ONE_TYPE_OVERRIDE, {"p1": id_})).fetchone()
    if row is None:
        return None
...
async def get_one_text_type_override(conn: ConnectionLike, *, id_: int) -> UserString | None:
    ...
    """
    row = await (await conn.execute(GET_ONE_TEXT_TYPE_OVERRIDE, {"p1": id_})).fetchone()
    if row is None:
        return None
...
async def delete_type_override(conn: ConnectionLike, *, id_: int) -> None:
    ...
    Args:
        ...
        id_: int.
    """
    await conn.execute(DELETE_TYPE_OVERRIDE, {"p1": id_})
...
async def insert_one_test_enum_type(conn: ConnectionLike, *, id_: int, mood: enums.TestMood, maybe_mood: enums.TestMood | None) -> None:
    ...
    """
    await conn.execute(INSERT_ONE_TEST_ENUM_TYPE, {"p1": id_, "p2": mood, "p3": maybe_mood})
...
async def get_one_test_enum_type(conn: ConnectionLike, *, id_: int) -> models.TestEnumType | None:
    ...
    """
    row = await (await conn.execute(GET_ONE_TEST_ENUM_TYPE, {"p1": id_})).fetchone()
    if row is None:
        return None
...
async def get_one_test_enum_value(conn: ConnectionLike, *, id_: int) -> enums.TestMood | None:
    ...
    """
    row = await (await conn.execute(GET_ONE_TEST_ENUM_VALUE, {"p1": id_})).fetchone()
    if row is None:
        return None
