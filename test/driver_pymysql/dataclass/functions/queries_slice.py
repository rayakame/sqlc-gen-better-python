...
def insert_slice_row(conn: pymysql.Connection, *, id_: int, name: str, note: str | None) -> None:
    ...
    with conn.cursor() as cur:
        cur.execute(INSERT_SLICE_ROW, (id_, name, note))


def get_slice_rows(conn: pymysql.Connection, *, ids: collections.abc.Sequence[int]) -> QueryResults[models.TestSlice]:
...
def get_slice_row_filtered(conn: pymysql.Connection, *, name: str, ids: collections.abc.Sequence[int], id_: int) -> models.TestSlice | None:
...
def get_slice_rows_by_notes(conn: pymysql.Connection, *, notes: collections.abc.Sequence[str]) -> QueryResults[models.TestSlice]:
...
def get_first_slice_name(conn: pymysql.Connection, *, ids: collections.abc.Sequence[int], names: collections.abc.Sequence[str]) -> str | None:
...
def get_slice_rows_by_name_or_note(conn: pymysql.Connection, *, names: collections.abc.Sequence[str]) -> QueryResults[models.TestSlice]:
...
def get_slice_rows_by_name_or_note_filtered(conn: pymysql.Connection, *, names: collections.abc.Sequence[str], id_: int) -> QueryResults[models.TestSlice]:
...
def delete_slice_rows(conn: pymysql.Connection, *, ids: collections.abc.Sequence[int]) -> int:
