...
class Model3RdPartyStat(msgspec.Struct):
...
class TestCaseSensitivity(msgspec.Struct):
...
class TestInnerMysqlType(msgspec.Struct):
...
class TestMysqlType(msgspec.Struct):
...
class TestReservedArg(msgspec.Struct):
