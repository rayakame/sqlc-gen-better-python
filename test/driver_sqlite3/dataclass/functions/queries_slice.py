...
def get_slice_row_filtered(conn: sqlite3.Connection, *, name: str, ids: collections.abc.Sequence[int], id_: int) -> models.TestSlice | None:
...
def get_slice_rows_by_name_or_note_filtered(conn: sqlite3.Connection, *, names: collections.abc.Sequence[str], id_: int) -> QueryResults[models.TestSlice]:
