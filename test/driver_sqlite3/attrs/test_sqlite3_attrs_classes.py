...
from test.driver_sqlite3.attrs.classes import queries
...
class TestSqlite3AttrsClasses:
    ...
    @pytest.mark.dependency(name="Sqlite3TestAttrsClasses::insert")
    def test_insert(
        self,
    ...
    @pytest.mark.dependency(name="Sqlite3TestAttrsClasses::inner_insert", depends=["Sqlite3TestAttrsClasses::insert"])
    ...
    @pytest.mark.dependency(name="Sqlite3TestAttrsClasses::get_one", depends=["Sqlite3TestAttrsClasses::inner_insert"])
    def test_get_one(
        self,
        queries_obj: queries.Queries,
        model: models.TestSqliteType,
    ...
    @pytest.mark.dependency(name="Sqlite3TestAttrsClasses::get_one_none", depends=["Sqlite3TestAttrsClasses::get_one"])
    ...
    @pytest.mark.dependency(
        name="Sqlite3TestAttrsClasses::get_many_date", depends=["Sqlite3TestAttrsClasses::get_many_inner_iter"]
    )
    ...
    @pytest.mark.dependency(
        name="Sqlite3TestAttrsClasses::get_many_timestamp",
    ...
    @pytest.mark.dependency(
        name="Sqlite3TestAttrsClasses::get_many_timestamp_iter",
