...
from test.driver_sqlite3.msgspec.functions import queries
...
class TestSqlite3MsgspecFunctions:
    ...
    @pytest.mark.dependency(name="Sqlite3TestMsgspecFunctions::insert")
    def test_insert(
        self,
    ...
    @pytest.mark.dependency(
        name="Sqlite3TestMsgspecFunctions::get_many_date", depends=["Sqlite3TestMsgspecFunctions::get_many_inner_iter"]
    )
    ...
    @pytest.mark.dependency(
        name="Sqlite3TestMsgspecFunctions::get_many_datetime",
    ...
    @pytest.mark.dependency(
        name="Sqlite3TestMsgspecFunctions::get_many_datetime_iter",
    ...
    @pytest.mark.dependency(
        name="Sqlite3TestMsgspecFunctions::get_many_timestamp",
    ...
    @pytest.mark.dependency(
        name="Sqlite3TestMsgspecFunctions::get_many_timestamp_iter",
    ...
    @pytest.mark.dependency(
        name="Sqlite3TestMsgspecFunctions::get_many_bool",
    ...
    @pytest.mark.dependency(
        name="Sqlite3TestMsgspecFunctions::get_many_boolean",
    ...
    @pytest.mark.dependency(
        name="Sqlite3TestMsgspecFunctions::get_many_boolean_iter",
    ...
    @pytest.mark.dependency(
        name="Sqlite3TestMsgspecFunctions::get_many_decimal",
    ...
    @pytest.mark.dependency(
        name="Sqlite3TestMsgspecFunctions::get_many_decimal_iter",
    ...
    @pytest.mark.dependency(
        name="Sqlite3TestMsgspecFunctions::get_many_blob",
