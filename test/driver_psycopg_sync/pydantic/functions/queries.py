...
class GetEmbeddedTestPostgresTypeRow(pydantic.BaseModel):
...
class GetAllEmbeddedTestPostgresTypeRow(pydantic.BaseModel):
...
class TestCopyFromParams(pydantic.BaseModel):
...
def get_one_test_postgres_type(conn: ConnectionLike, *, id_: int) -> models.TestPostgresType | None:
    ...
    """
    row = conn.execute(GET_ONE_TEST_POSTGRES_TYPE, {"p1": id_}).fetchone()
    if row is None:
        return None
...
def get_one_inner_test_postgres_type(conn: ConnectionLike, *, table_id: int) -> models.TestInnerPostgresType | None:
    ...
    """
    row = conn.execute(GET_ONE_INNER_TEST_POSTGRES_TYPE, {"p1": table_id}).fetchone()
    if row is None:
        return None
...
def get_one_test_timestamp_postgres_type(conn: ConnectionLike, *, id_: int) -> datetime.datetime | None:
    ...
    """
    row = conn.execute(GET_ONE_TEST_TIMESTAMP_POSTGRES_TYPE, {"p1": id_}).fetchone()
    if row is None:
        return None
    return row[0]


def get_one_test_bytea_postgres_type(conn: ConnectionLike, *, id_: int) -> memoryview | None:
    ...
    """
    row = conn.execute(GET_ONE_TEST_BYTEA_POSTGRES_TYPE, {"p1": id_}).fetchone()
    if row is None:
        return None
...
def get_many_test_postgres_type(conn: ConnectionLike, *, id_: int) -> QueryResults[models.TestPostgresType]:
    ...
    return QueryResults(conn, GET_MANY_TEST_POSTGRES_TYPE, _decode_hook, {"p1": id_})
...
def get_many_test_iterator_postgres_type(conn: ConnectionLike, *, id_: int) -> QueryResults[models.TestPostgresType]:
    ...
    return QueryResults(conn, GET_MANY_TEST_ITERATOR_POSTGRES_TYPE, _decode_hook, {"p1": id_})
...
def get_many_test_timestamp_postgres_type(conn: ConnectionLike, *, id_: int) -> QueryResults[datetime.datetime]:
    ...
    """
    return QueryResults(conn, GET_MANY_TEST_TIMESTAMP_POSTGRES_TYPE, operator.itemgetter(0), {"p1": id_})
...
def get_many_test_bytea_postgres_type(conn: ConnectionLike, *, id_: int) -> QueryResults[memoryview]:
    ...
    return QueryResults(conn, GET_MANY_TEST_BYTEA_POSTGRES_TYPE, _decode_hook, {"p1": id_})


def get_embedded_test_postgres_type(conn: ConnectionLike, *, id_: int) -> GetEmbeddedTestPostgresTypeRow | None:
    ...
    """
    row = conn.execute(GET_EMBEDDED_TEST_POSTGRES_TYPE, {"p1": id_}).fetchone()
    if row is None:
        return None
...
def get_all_embedded_test_postgres_type(conn: ConnectionLike, *, id_: int) -> GetAllEmbeddedTestPostgresTypeRow | None:
    ...
    """
    row = conn.execute(GET_ALL_EMBEDDED_TEST_POSTGRES_TYPE, {"p1": id_}).fetchone()
    if row is None:
        return None
...
def create_one_test_postgres_type(
    conn: ConnectionLike,
    *,
    id_: int,
    serial_test: int,
    ...
    conn.execute(CREATE_ONE_TEST_POSTGRES_TYPE, sql_params)


def create_one_test_postgres_inner_type(
    conn: ConnectionLike,
    *,
    table_id: int,
    ...
    conn.execute(CREATE_ONE_TEST_POSTGRES_INNER_TYPE, sql_params)


def delete_one_test_postgres_type(conn: ConnectionLike, *, id_: int) -> None:
    ...
    Args:
        ...
        id_: int.
    """
    conn.execute(DELETE_ONE_TEST_POSTGRES_TYPE, {"p1": id_})


def delete_one_test_postgres_inner_type(conn: ConnectionLike, *, table_id: int) -> None:
    ...
    Args:
        ...
        table_id: int.
    """
    conn.execute(DELETE_ONE_TEST_POSTGRES_INNER_TYPE, {"p1": table_id})


def create_result_one_test_postgres_type(
    conn: ConnectionLike,
    *,
    id_: int,
    serial_test: int,
    ...
    Returns:
        The result of type `psycopg.Cursor[psycopg.rows.TupleRow]` returned when executing the query.
    """
    sql_params = {
        "p1": id_,
        "p2": serial_test,
    ...
    return conn.execute(CREATE_RESULT_ONE_TEST_POSTGRES_TYPE, sql_params)


def update_result_test_postgres_type(conn: ConnectionLike, *, id_: int) -> psycopg.Cursor[psycopg.rows.TupleRow]:
    ...
    Returns:
        The result of type `psycopg.Cursor[psycopg.rows.TupleRow]` returned when executing the query.
    """
    return conn.execute(UPDATE_RESULT_TEST_POSTGRES_TYPE, {"p1": id_})


def delete_one_result_test_postgres_type(conn: ConnectionLike, *, id_: int) -> psycopg.Cursor[psycopg.rows.TupleRow]:
    ...
    Returns:
        The result of type `psycopg.Cursor[psycopg.rows.TupleRow]` returned when executing the query.
    """
    return conn.execute(DELETE_ONE_RESULT_TEST_POSTGRES_TYPE, {"p1": id_})


def create_rows_one_test_postgres_type(
    conn: ConnectionLike,
    *,
    id_: int,
    serial_test: int,
    ...
    cur = conn.execute(CREATE_ROWS_ONE_TEST_POSTGRES_TYPE, sql_params)
    return cur.rowcount


def update_rows_test_postgres_type(conn: ConnectionLike, *, id_: int) -> int:
    ...
    Returns:
        The number (`int`) of affected rows. This will be -1 for queries like `CREATE TABLE`.
    """
    cur = conn.execute(UPDATE_ROWS_TEST_POSTGRES_TYPE, {"p1": id_})
    return cur.rowcount


def delete_one_rows_test_postgres_type(conn: ConnectionLike, *, id_: int) -> int:
    ...
    Returns:
        The number (`int`) of affected rows. This will be -1 for queries like `CREATE TABLE`.
    """
    cur = conn.execute(DELETE_ONE_ROWS_TEST_POSTGRES_TYPE, {"p1": id_})
    return cur.rowcount


def create_rows_table(conn: ConnectionLike) -> int:
    ...
    Returns:
        The number (`int`) of affected rows. This will be -1 for queries like `CREATE TABLE`.
    """
    cur = conn.execute(CREATE_ROWS_TABLE)
    return cur.rowcount


def test_copy_from(conn: ConnectionLike, *, params: collections.abc.Sequence[TestCopyFromParams]) -> int:
    ...
    with conn.cursor() as cur:
        with cur.copy('COPY "test_copy_from" ("id", "float_test", "int_test") FROM STDIN') as copy:
            for param in params:
                copy.write_row((param.id_, param.float_test, param.int_test))
        return cur.rowcount


def insert_type_override(conn: ConnectionLike, *, id_: int, text_test: UserString | None) -> None:
    ...
    """
    conn.execute(INSERT_TYPE_OVERRIDE, {"p1": id_, "p2": str(text_test) if text_test is not None else None})


def get_one_type_override(conn: ConnectionLike, *, id_: int) -> models.TestTypeOverride | None:
    ...
    """
    row = conn.execute(GET_ONE_TYPE_OVERRIDE, {"p1": id_}).fetchone()
    if row is None:
        return None
...
def get_many_type_override(conn: ConnectionLike, *, id_: int) -> QueryResults[models.TestTypeOverride]:
    ...
    return QueryResults(conn, GET_MANY_TYPE_OVERRIDE, _decode_hook, {"p1": id_})


def get_one_text_type_override(conn: ConnectionLike, *, id_: int) -> UserString | None:
    ...
    """
    row = conn.execute(GET_ONE_TEXT_TYPE_OVERRIDE, {"p1": id_}).fetchone()
    if row is None:
        return None
    return UserString(row[0]) if row[0] is not None else None


def get_many_text_type_override(conn: ConnectionLike, *, id_: int) -> QueryResults[UserString | None]:
    ...
    Returns:
        Helper class of type `QueryResults[UserString | None]` that allows both iteration and normal fetching of data from the db.
    """

    def _decode_hook(row: psycopg.rows.TupleRow) -> UserString | None:
        return UserString(row[0]) if row[0] is not None else None

    return QueryResults(conn, GET_MANY_TEXT_TYPE_OVERRIDE, _decode_hook, {"p1": id_})


def delete_type_override(conn: ConnectionLike, *, id_: int) -> None:
    ...
    Args:
        ...
        id_: int.
    """
    conn.execute(DELETE_TYPE_OVERRIDE, {"p1": id_})


def insert_one_test_enum_type(conn: ConnectionLike, *, id_: int, mood: enums.TestMood, maybe_mood: enums.TestMood | None) -> None:
    ...
    """
    conn.execute(INSERT_ONE_TEST_ENUM_TYPE, {"p1": id_, "p2": mood, "p3": maybe_mood})


def get_one_test_enum_type(conn: ConnectionLike, *, id_: int) -> models.TestEnumType | None:
    ...
    Returns:
        Result of type `models.TestEnumType` fetched from the db. Will be `None` if not found.
    """
    row = conn.execute(GET_ONE_TEST_ENUM_TYPE, {"p1": id_}).fetchone()
    if row is None:
        return None
...
def get_one_test_enum_value(conn: ConnectionLike, *, id_: int) -> enums.TestMood | None:
    ...
    Returns:
        Result of type `enums.TestMood` fetched from the db. Will be `None` if not found.
    """
    row = conn.execute(GET_ONE_TEST_ENUM_VALUE, {"p1": id_}).fetchone()
    if row is None:
        return None
    return enums.TestMood(row[0])


def get_many_test_enum_types(conn: ConnectionLike) -> QueryResults[models.TestEnumType]:
    ...
    Returns:
        Helper class of type `QueryResults[models.TestEnumType]` that allows both iteration and normal fetching of data from the db.
    """
...
def delete_one_test_enum_type(conn: ConnectionLike, *, id_: int) -> int:
    ...
    Returns:
        The number (`int`) of affected rows. This will be -1 for queries like `CREATE TABLE`.
    """
    cur = conn.execute(DELETE_ONE_TEST_ENUM_TYPE, {"p1": id_})
    return cur.rowcount
