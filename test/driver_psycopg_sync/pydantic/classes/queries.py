...
class Queries:
    ...
    def get_one_test_postgres_type(self, *, id_: int) -> models.TestPostgresType | None:
        ...
        """
        row = self._conn.execute(GET_ONE_TEST_POSTGRES_TYPE, {"p1": id_}).fetchone()
        if row is None:
            return None
    ...
    def get_one_inner_test_postgres_type(self, *, table_id: int) -> models.TestInnerPostgresType | None:
        ...
        """
        row = self._conn.execute(GET_ONE_INNER_TEST_POSTGRES_TYPE, {"p1": table_id}).fetchone()
        if row is None:
            return None
    ...
    def get_one_test_timestamp_postgres_type(self, *, id_: int) -> datetime.datetime | None:
        ...
        """
        row = self._conn.execute(GET_ONE_TEST_TIMESTAMP_POSTGRES_TYPE, {"p1": id_}).fetchone()
        if row is None:
            return None
        return row[0]

    def get_one_test_bytea_postgres_type(self, *, id_: int) -> memoryview | None:
        ...
        """
        row = self._conn.execute(GET_ONE_TEST_BYTEA_POSTGRES_TYPE, {"p1": id_}).fetchone()
        if row is None:
            return None
    ...
    def get_embedded_test_postgres_type(self, *, id_: int) -> GetEmbeddedTestPostgresTypeRow | None:
        ...
        """
        row = self._conn.execute(GET_EMBEDDED_TEST_POSTGRES_TYPE, {"p1": id_}).fetchone()
        if row is None:
            return None
    ...
    def get_all_embedded_test_postgres_type(self, *, id_: int) -> GetAllEmbeddedTestPostgresTypeRow | None:
        ...
        """
        row = self._conn.execute(GET_ALL_EMBEDDED_TEST_POSTGRES_TYPE, {"p1": id_}).fetchone()
        if row is None:
            return None
    ...
    def create_one_test_postgres_type(
        ...
        *,
        ...
        self._conn.execute(CREATE_ONE_TEST_POSTGRES_TYPE, sql_params)
    ...
    def create_one_test_postgres_inner_type(
        ...
        *,
        ...
        self._conn.execute(CREATE_ONE_TEST_POSTGRES_INNER_TYPE, sql_params)

    def delete_one_test_postgres_type(self, *, id_: int) -> None:
        ...
        Args:
            id_: int.
        """
        self._conn.execute(DELETE_ONE_TEST_POSTGRES_TYPE, {"p1": id_})

    def delete_one_test_postgres_inner_type(self, *, table_id: int) -> None:
        ...
        Args:
            table_id: int.
        """
        self._conn.execute(DELETE_ONE_TEST_POSTGRES_INNER_TYPE, {"p1": table_id})
    ...
    def create_result_one_test_postgres_type(
        ...
        *,
        ...
        return self._conn.execute(CREATE_RESULT_ONE_TEST_POSTGRES_TYPE, sql_params)

    def update_result_test_postgres_type(self, *, id_: int) -> psycopg.Cursor[psycopg.rows.TupleRow]:
        ...
        Returns:
            The result of type `psycopg.Cursor[psycopg.rows.TupleRow]` returned when executing the query.
        """
        return self._conn.execute(UPDATE_RESULT_TEST_POSTGRES_TYPE, {"p1": id_})

    def delete_one_result_test_postgres_type(self, *, id_: int) -> psycopg.Cursor[psycopg.rows.TupleRow]:
        ...
        Returns:
            The result of type `psycopg.Cursor[psycopg.rows.TupleRow]` returned when executing the query.
        """
        return self._conn.execute(DELETE_ONE_RESULT_TEST_POSTGRES_TYPE, {"p1": id_})
    ...
    def create_rows_one_test_postgres_type(
        ...
        *,
        ...
        cur = self._conn.execute(CREATE_ROWS_ONE_TEST_POSTGRES_TYPE, sql_params)
        return cur.rowcount

    def update_rows_test_postgres_type(self, *, id_: int) -> int:
        ...
        Returns:
            The number (`int`) of affected rows. This will be -1 for queries like `CREATE TABLE`.
        """
        cur = self._conn.execute(UPDATE_ROWS_TEST_POSTGRES_TYPE, {"p1": id_})
        return cur.rowcount

    def delete_one_rows_test_postgres_type(self, *, id_: int) -> int:
        ...
        Returns:
            The number (`int`) of affected rows. This will be -1 for queries like `CREATE TABLE`.
        """
        cur = self._conn.execute(DELETE_ONE_ROWS_TEST_POSTGRES_TYPE, {"p1": id_})
        return cur.rowcount
    ...
    def create_rows_table(self) -> int:
        ...
        Returns:
            The number (`int`) of affected rows. This will be -1 for queries like `CREATE TABLE`.
        """
        cur = self._conn.execute(CREATE_ROWS_TABLE)
        return cur.rowcount

    def test_copy_from(self, *, params: collections.abc.Sequence[TestCopyFromParams]) -> int:
    ...
    def insert_type_override(self, *, id_: int, text_test: UserString | None) -> None:
        ...
        """
        self._conn.execute(INSERT_TYPE_OVERRIDE, {"p1": id_, "p2": str(text_test) if text_test is not None else None})
    ...
    def get_one_type_override(self, *, id_: int) -> models.TestTypeOverride | None:
        ...
        """
        row = self._conn.execute(GET_ONE_TYPE_OVERRIDE, {"p1": id_}).fetchone()
        if row is None:
            return None
    ...
    def get_one_text_type_override(self, *, id_: int) -> UserString | None:
        ...
        """
        row = self._conn.execute(GET_ONE_TEXT_TYPE_OVERRIDE, {"p1": id_}).fetchone()
        if row is None:
            return None
    ...
    def delete_type_override(self, *, id_: int) -> None:
        ...
        Args:
            id_: int.
        """
        self._conn.execute(DELETE_TYPE_OVERRIDE, {"p1": id_})

    def insert_one_test_enum_type(self, *, id_: int, mood: enums.TestMood, maybe_mood: enums.TestMood | None) -> None:
        ...
        """
        self._conn.execute(INSERT_ONE_TEST_ENUM_TYPE, {"p1": id_, "p2": mood, "p3": maybe_mood})

    def get_one_test_enum_type(self, *, id_: int) -> models.TestEnumType | None:
        ...
        """
        row = self._conn.execute(GET_ONE_TEST_ENUM_TYPE, {"p1": id_}).fetchone()
        if row is None:
            return None
    ...
    def get_one_test_enum_value(self, *, id_: int) -> enums.TestMood | None:
        ...
        """
        row = self._conn.execute(GET_ONE_TEST_ENUM_VALUE, {"p1": id_}).fetchone()
        if row is None:
            return None
    ...
    def delete_one_test_enum_type(self, *, id_: int) -> int:
        ...
        Returns:
            The number (`int`) of affected rows. This will be -1 for queries like `CREATE TABLE`.
        """
        cur = self._conn.execute(DELETE_ONE_TEST_ENUM_TYPE, {"p1": id_})
        return cur.rowcount
