...
class QueryResults[T]:
    ...
    def __init__(
        ...
        decode_hook -- A callback that turns an `psycopg.rows.TupleRow` object into `T` that will be returned.
...
def create_result_one_test_postgres_type(
    ...
    *,
    ...
    Returns:
    psycopg.Cursor[psycopg.rows.TupleRow] -- The result returned when executing the query.
    """
    sql_params = {
        "p1": id_,
        "p2": serial_test,
...
def get_one_test_enum_type(conn: ConnectionLike, *, id_: int) -> models.TestEnumType | None:
    ...
    Returns:
    models.TestEnumType -- Result fetched from the db. Will be `None` if not found.
    """
...
def get_one_test_enum_value(conn: ConnectionLike, *, id_: int) -> enums.TestMood | None:
    ...
    Returns:
    enums.TestMood -- Result fetched from the db. Will be `None` if not found.
    """
...
def get_many_test_enum_types(conn: ConnectionLike) -> QueryResults[models.TestEnumType]:
    ...
    Returns:
    QueryResults[models.TestEnumType] -- Helper class that allows both iteration and normal fetching of data from the db.
    """
