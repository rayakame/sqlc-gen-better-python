...
__all__: collections.abc.Sequence[str] = (
    ...
    "get_many_nullable_test_postgres_type",
...
GET_MANY_NULLABLE_TEST_POSTGRES_TYPE: typing.Final[str] = """-- name: GetManyNullableTestPostgresType :many
SELECT table_id, serial_test, serial4_test, bigserial_test, smallserial_test, int_test, bigint_test, smallint_test, float_test, double_precision_test, real_test, numeric_test, money_test, bool_test, json_test, jsonb_test, bytea_test, date_test, time_test, timetz_test, timestamp_test, timestamptz_test, interval_test, text_test, varchar_test, bpchar_test, char_test, citext_test, uuid_test, inet_test, cidr_test, macaddr_test, macaddr8_test, ltree_test, lquery_test, ltxtquery_test FROM test_inner_postgres_types WHERE table_id = $1 AND int_test = $2
"""
...
def get_many_nullable_test_postgres_type(conn: ConnectionLike, *, table_id: int, int_test: int | None) -> QueryResults[models.TestInnerPostgresType]:
    """Fetch many from the db using the SQL query with `name: GetManyNullableTestPostgresType :many`.
    ...
    Returns:
        Helper class of type `QueryResults[models.TestInnerPostgresType]` that allows both iteration and normal fetching of data from the db.
    """
    def _decode_hook(row: asyncpg.Record) -> models.TestInnerPostgresType:
    ...
    return QueryResults[models.TestInnerPostgresType](conn, GET_MANY_NULLABLE_TEST_POSTGRES_TYPE, _decode_hook, table_id, int_test)
...
def get_many_test_timestamp_postgres_type(conn: ConnectionLike, *, id_: int) -> QueryResults[datetime.datetime]:
    ...
    def _decode_hook(row: asyncpg.Record) -> datetime.datetime:
        return row[0]
    return QueryResults[datetime.datetime](conn, GET_MANY_TEST_TIMESTAMP_POSTGRES_TYPE, _decode_hook, id_)
