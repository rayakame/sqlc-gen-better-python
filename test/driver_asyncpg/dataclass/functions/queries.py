...
async def get_embedded_test_postgres_type(conn: asyncpg.Connection[asyncpg.Record]) -> typing.Sequence[GetEmbeddedTestPostgresTypeRow]:
...
async def get_one_test_postgres_type(conn: asyncpg.Connection[asyncpg.Record]) -> models.TestPostgresType | None:
...
async def get_one_test_timestamp_postgres_type(conn: asyncpg.Connection[asyncpg.Record]) -> datetime.datetime | None:
