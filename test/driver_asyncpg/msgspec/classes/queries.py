...
class Queries:
    ...
    def get_many_nullable_test_postgres_type(self, *, table_id: int, int_test: int | None) -> QueryResults[models.TestInnerPostgresType]:
        ...
        return QueryResults[models.TestInnerPostgresType](self._conn, GET_MANY_NULLABLE_TEST_POSTGRES_TYPE, _decode_hook, table_id, int_test)
