...
__all__: collections.abc.Sequence[str] = (
    ...
    "get_field_naming",
    "get_field_naming_duplicate_columns",
    ...
    "test_copy_from",
    "update_field_naming_mixed_params",
...
async def get_field_naming_duplicate_columns(conn: ConnectionLike, *, id_: int) -> GetFieldNamingDuplicateColumnsRow | None:
    ...
    """
    row = await conn.fetchrow(GET_FIELD_NAMING_DUPLICATE_COLUMNS, id_)
    if row is None:
        return None
...
async def update_field_naming_mixed_params(conn: ConnectionLike, *, id_: int, outputs: str, outputs_2: str) -> None:
    ...
    outputs_2 -- str.
    """
    await conn.execute(UPDATE_FIELD_NAMING_MIXED_PARAMS, id_, outputs, outputs_2)
