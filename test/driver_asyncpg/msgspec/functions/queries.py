...
__all__: collections.abc.Sequence[str] = (
    ...
    "QueryResults",
    "copy_from_one_test_postgres_type",
...
class CopyFromOneTestPostgresTypeParams(msgspec.Struct):
...
async def copy_from_one_test_postgres_type(conn: ConnectionLike, *, params: collections.abc.Sequence[CopyFromOneTestPostgresTypeParams]) -> int:
    ...
    params -- collections.abc.Sequence[CopyFromOneTestPostgresTypeParams]. A list of params for rows that should be inserted.
    ...
    result = await conn.copy_records_to_table("test_postgres_types", records=records)
